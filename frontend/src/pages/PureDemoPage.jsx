...
const PureDemoPage = () => {
  ...
  // Demo products data - completely offline
  const demoProducts = [
    {
      id: 1,
      ...
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Smartphone+Quantum+X"
    },
    {
      id: 2,
      ...
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Laptop+Nebula+Pro"
    },
    {
      id: 3,
      ...
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Casque+VR+Reality"
    },
    {
      id: 4,
      ...
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Montre+Connectée+Time"
    },
    {
      id: 5,
      ...
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Drone+Sky+Explorer"
    },
    {
      id: 6,
      ...
      price: 199,
      category: { name: "Audio" },
      image: "https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Enceinte+Sonic+Wave"
    }
  ];

  // Pure local cart functions - NO API CALLS
  const addToCart = (productId) => {
    ...
    if (product) {
      ...
      // Simple alert instead of toast to avoid any API
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      {/* Simple Background - no animations to avoid issues */}
                    ...
                    <div className="space-y-3">
                      ...
                      <Link to="/login">
                        <motion.button
                          whileHover={{ scale: 1.02 }}
                          whileTap={{ scale: 0.98 }}
                          className="w-full bg-transparent border-2 border-cyan-500 py-4 rounded-2xl text-cyan-400 font-bold text-lg hover:bg-cyan-500/10 transition-all"
                        >
            ...
            <div className="bg-black/50 backdrop-blur-xl rounded-2xl p-8 border border-cyan-500/20">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    type="email"
                    className="w-full px-4 py-3 bg-black/50 border border-cyan-500/30 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-cyan-500"
                ...
                <motion.button
                  whileHover={{ scale: 1.02 }}
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-gradient-to-r from-cyan-600 to-purple-600 py-3 rounded-xl text-white font-bold"
                  onClick={() => alert('Fonction de connexion démo - Redirection vers /login')}
                >
                  Se connecter
                </motion.button>
