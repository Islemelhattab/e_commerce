...
const FuturisticMarketplacePage = () => {
                      ...
                      <div className="relative h-64 overflow-hidden">
                        {product.images && product.images.length > 0 ? (
                          <img
                            ...
                            onError={(e) => {
                              e.target.src = 'https://via.placeholder.com/400x300/1a1a1a/ffffff?text=Image+non+disponible';
                            }}
                          />
                        ) : (
                          <div className="w-full h-full bg-gradient-to-br from-purple-800 to-cyan-800 flex items-center justify-center">
                      ...
                      <div className="relative h-48 overflow-hidden">
                        {product.images && product.images.length > 0 ? (
                          <img
                            ...
                            className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500"
                            onError={(e) => {
                              e.target.src = 'https://via.placeholder.com/300x200/1a1a1a/ffffff?text=Image+non+disponible';
                            }}
                          />
                        ) : (
                          <div className="w-full h-full bg-gradient-to-br from-purple-800 to-cyan-800 flex items-center justify-center">
                            ...
                            {item.product?.images?.[0] ? (
                              <img
                                ...
                                onError={(e) => {
                                  ...
                                  e.target.parentElement.innerHTML = `<span class="text-white/50 text-sm">${item.product.name}</span>`;
                                }}
                              />
                            ) : (
                              <span className="text-white/50 text-sm">{item.product?.name}</span>
                            )}
                          </div>
                    ...
                    <div className="mt-8 p-6 bg-gradient-to-r from-purple-900/50 to-cyan-900/50 backdrop-blur-xl rounded-2xl border border-cyan-500/20">
                      <div className="flex justify-between items-center mb-6">
                        ...
                        <span className="text-2xl font-bold bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent">
                          {cart.reduce((total, item) => total + (item.product?.price || 0) * item.quantity, 0)} DT
                        </span>
                      </div>
          ...
          {activeSection === 'profile' && (
            ...
            >
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Membre depuis aujourd'hui</p>
              </div>
...
export default FuturisticMarketplacePage;
