...
const BeautifulDemoPage = () => {
  ...
  const showNotification = (message) => {
    ...
    notification.className = 'fixed top-4 right-4 bg-gradient-to-r from-blue-500 to-cyan-500 text-white px-6 py-3 rounded-lg shadow-lg z-50 animate-pulse';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-cyan-50 text-gray-800 overflow-hidden">
      ...
      <div className="fixed inset-0 bg-gradient-to-br from-blue-100/30 via-white/50 to-cyan-100/30">
        <div className="absolute inset-0 bg-blue-200/10 opacity-20"></div>
      </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-xl border border-blue-100">
              ...
              <div className="space-y-4">
                ...
                <motion.button
                  ...
                  onClick={() => showNotification('Redirection vers la page de connexion...')}
                >
                  Se connecter
                </motion.button>
...
export default BeautifulDemoPage;
